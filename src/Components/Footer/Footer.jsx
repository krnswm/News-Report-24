        ...
        <div className='footer-container'>
            <div className='footer-content'>
                <div className='footer-left'>
                    <Link to={"/"} ><img src={logo} alt='logo' onClick={() => window.scroll(0, 0)} className='footer-logo' title='News Report 24' /></Link>
                </div>
                <div className='footer-right'>
                    <div className='right-content'>
                        <div className='contact'><Link to='mailto:newsreport23@gmail.com' className='mail-link' target="_blank"
                            rel="noopener noreferrer">Contact Us</Link></div>
